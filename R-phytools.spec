...
Version  : 0.7.47
Release  : 18
URL      : https://cran.r-project.org/src/contrib/phytools_0.7-47.tar.gz
Source0  : https://cran.r-project.org/src/contrib/phytools_0.7-47.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591115466
