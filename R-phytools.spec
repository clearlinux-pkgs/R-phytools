...
Version  : 0.7.70
Release  : 24
URL      : https://cran.r-project.org/src/contrib/phytools_0.7-70.tar.gz
Source0  : https://cran.r-project.org/src/contrib/phytools_0.7-70.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600709140
